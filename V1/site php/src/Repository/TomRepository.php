 ...
 */
class TomRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Tom $entity, bool $flush = false): void
    {
    ...
    public function remove(Tom $entity, bool $flush = false): void
    {
